        ...
        <div>
          ...
          <div className="flex flex-col justify-center w-[50%] mx-auto min-h-[30vh] text-justify my-24">
            ...
            <p className="text-justify my-8">
              ...
              wardrobe. At OHMYCOTTON, your daily rituals are at the heart of
              our design. We make clothing to give you your best day, every day.
              Our goal is to make people proud and happy to live with our
              products.
            </p>
